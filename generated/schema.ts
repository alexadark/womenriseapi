...
export class Token extends Entity {
  constructor(id: string) {
    ...
    this.set("skins", Value.fromString(""));
    this.set("background", Value.fromString(""));
    this.set("lips", Value.fromString(""));
    this.set("eyes", Value.fromString(""));
    this.set("accessories", Value.fromString(""));
  ...
  get skins(): string {
    let value = this.get("skins");
    return value!.toString();
  }

  set skins(value: string) {
    this.set("skins", Value.fromString(value));
  }
  ...
  get lips(): string {
    let value = this.get("lips");
    return value!.toString();
  }

  set lips(value: string) {
    this.set("lips", Value.fromString(value));
  }
  ...
  get accessories(): string {
    let value = this.get("accessories");
    return value!.toString();
  }

  set accessories(value: string) {
    this.set("accessories", Value.fromString(value));
  }
